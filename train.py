...
# Check the `prior_preservation` option if you would like class
# of the concept (e.g.: toy, dog, painting) is guaranteed to be preserved.
# This increases the quality and helps with generalization at the cost of training time
